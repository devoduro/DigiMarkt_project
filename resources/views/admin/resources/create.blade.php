...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center">
        <h3 class="text-3xl font-medium text-gray-700">Add New Resource</h3>
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('admin.resources.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-500 text-xs mt-1">Recommended size: 300x200 pixels. Max file size: 2MB.</p>
                        @error('thumbnail')
                            <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-500 text-xs mt-1">Allowed file types: PDF, DOC, DOCX, PPT, PPTX, XLS, XLSX, ZIP. Max file size: 10MB.</p>
                        @error('file')
                            <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="access_level" id="access_level" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('access_level') border-red-500 @enderror" required>
                            <option value="public" {{ old('access_level') == 'public' ? 'selected' : '' }}>Public (Anyone can access)</option>
                            <option value="registered" {{ old('access_level') == 'registered' ? 'selected' : '' }}>Registered Users Only</option>
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_featured" id="is_featured" class="mr-2 leading-tight @error('is_featured') border-red-500 @enderror" {{ old('is_featured') ? 'checked' : '' }}>
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_published" id="is_published" class="mr-2 leading-tight @error('is_published') border-red-500 @enderror" {{ old('is_published', true) ? 'checked' : '' }}>
