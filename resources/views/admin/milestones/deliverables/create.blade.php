...
<div class="container mx-auto px-6 py-8">
    <div class="flex justify-between items-center">
        <h3 class="text-3xl font-medium text-gray-700">Add New Deliverable</h3>
    ...
    <div class="mt-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('admin.milestones.deliverables.store', $milestone) }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="completed" id="completed" class="mr-2 leading-tight @error('completed') border-red-500 @enderror" {{ old('completed') ? 'checked' : '' }}>
