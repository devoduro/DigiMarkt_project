                ...
                <form action="{{ route('admin.milestones.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="shadow-sm border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition duration-200 @error('title') border-red-500 @enderror" value="{{ old('title') }}" required placeholder="Enter milestone title">
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="date" id="date" class="shadow-sm border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition duration-200 @error('date') border-red-500 @enderror" value="{{ old('date') }}" required>
                            @error('date')
                                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <input type="range" name="completion_percentage" id="completion_percentage" min="0" max="100" step="5" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer @error('completion_percentage') border-red-500 @enderror" value="{{ old('completion_percentage', 0) }}" required oninput="updateCompletionValue(this.value)">
                                <span id="completion_value" class="ml-4 bg-gray-100 text-gray-800 text-sm font-semibold px-3 py-1 rounded-full min-w-[60px] text-center">0%</span>
                            </div>
                    ...
                    <div class="mb-6 mt-4">
                        ...
                        <textarea name="description" id="description" rows="5" class="shadow-sm border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition duration-200 @error('description') border-red-500 @enderror" required placeholder="Enter milestone description">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6 mt-4">
                        <div class="flex items-center bg-gray-50 p-4 rounded-lg border border-gray-200">
                            <input type="checkbox" name="featured" id="featured" class="w-5 h-5 text-primary focus:ring-primary rounded transition duration-200 @error('featured') border-red-500 @enderror" {{ old('featured') ? 'checked' : '' }}>
