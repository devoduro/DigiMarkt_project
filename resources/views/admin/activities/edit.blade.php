                ...
                <form action="{{ route('admin.activities.update', $activity) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="featured" id="featured" value="1" class="mr-2 leading-tight @error('featured') border-red-500 @enderror" {{ old('featured', $activity->featured) ? 'checked' : '' }}>
