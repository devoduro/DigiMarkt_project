    ...
    public function milestones()
    {
        ...
        $workPackages = [
            [
                ...
                'description' => 'Management and coordination of all project activities and deliverables.',
                'status' => 'In Progress',
                'completion' => 70
            ],
            [
                'title' => 'WP2: Social Digital Entrepreneurship and Needs Analysis',
                'description' => 'Research and analysis of digital marketing needs in TVET education.',
                'status' => 'Completed',
                'completion' => 100
            ],
            [
                'title' => 'WP3: Training Materials and Mentorship',
                'description' => 'Development of training materials and mentorship programs for digital marketing.',
                'status' => 'In Progress',
                'completion' => 60
            ],
            [
                'title' => 'WP4: Quality Evaluation and Assurance',
                'description' => 'Ensuring quality standards across all project deliverables and activities.',
                'status' => 'In Progress',
                'completion' => 50
            ],
            [
                'title' => 'WP5: Project Impact and Dissemination',
                'description' => 'Measuring project impact and disseminating results to stakeholders.',
                'status' => 'Pending',
                'completion' => 30
            ]
        ];
        ...
        $partners = [
            [
                'name' => 'Steinbeis Beratungszentrum (SRZ)',
                'logo' => 'https://via.placeholder.com/150x80?text=SRZ',
                'country' => 'Germany'
            ],
            [
                'name' => 'Slovak University of Agriculture',
                'logo' => 'https://via.placeholder.com/150x80?text=SUA',
                'country' => 'Slovakia'
            ],
            [
                'name' => 'Akenten Appiah-Menka University of Skills Training and Entrepreneurial Development (AAMUSTED)',
                'logo' => 'https://via.placeholder.com/150x80?text=AAMUSTED',
                'country' => 'Ghana'
            ],
            [
                'name' => 'Bolgatanga Technical University (BTU)',
                'logo' => 'https://via.placeholder.com/150x80?text=BTU',
                'country' => 'Ghana'
            ],
            [
                'name' => 'Cape-Coast Technical University (CCTU)',
                'logo' => 'https://via.placeholder.com/150x80?text=CCTU',
                'country' => 'Ghana'
            ]
        ];
        ...
        $gallery = [
            [
                'title' => 'Digital Marketing Training in Slovakia -- April 28 - May 02, 2025',
                'image' => 'https://via.placeholder.com/600x400?text=Digital+Marketing+Training',
                'category' => 'Training'
            ],
            [
                'title' => 'Kick-off Meeting in Germany',
                'image' => 'https://via.placeholder.com/600x400?text=Kick-off+Meeting',
                'category' => 'Meeting'
            ],
            [
                'title' => 'Digital Marketing Laboratory Equipment',
                'image' => 'https://via.placeholder.com/600x400?text=Lab+Equipment',
                'category' => 'Equipment'
            ]
        ];
        
        return view('pages.milestones', compact('workPackages', 'partners', 'gallery'));
    }
