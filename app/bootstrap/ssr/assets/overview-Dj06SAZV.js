...
const Overview = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-10", children: [
    /* @__PURE__ */ jsx(Renderer, { value: exam.description }),
    /* @__PURE__ */ jsxs(Accordion, { type: "single", collapsible: true, children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "border-border border-y", children: (_a = exam.faqs) == null ? void 0 : _a.map((faq) => /* @__PURE__ */ jsxs(AccordionItem, { value: faq.id, className: "px-4 last:border-none", children: [
