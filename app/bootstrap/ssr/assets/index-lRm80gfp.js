...
import CouponTableColumns from "./coupon-table-columns-DPSGsojE.js";
...
const CouponsIndex = ({ coupons, courses }) => {
  var _a;
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Head, { title: "Course Coupons" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-gray-900", children: "Course Coupons" }),
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm text-gray-600", children: "Manage discount coupons for your Courses" })
        ] }),
        /* @__PURE__ */ jsx(
          CouponForm,
          {
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsx(TableFooter, { className: "p-5 sm:p-7", routeName: "Course-coupons.index", paginationInfo: coupons })
      ] })
    ] })
  ] });
};
