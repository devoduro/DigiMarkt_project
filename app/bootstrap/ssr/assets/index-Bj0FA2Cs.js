...
import InstructorsTableColumn from "./instructors-table-columns-CjIfTC5G.js";
...
const Index = (props) => {
  ...
  const table = useReactTable({
    ...
    columns: InstructorsTableColumn(isAdmin, props.translate),
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(Link, { href: route("instructors.create"), children: /* @__PURE__ */ jsx(Button, { children: button.add_new_instructor }) }),
