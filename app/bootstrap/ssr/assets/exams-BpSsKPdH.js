...
const Exams = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(EnrollmentModal, { type: "exam", title: "Add New Exam Enrollment", handler: /* @__PURE__ */ jsx(Button, { children: button.add_new_enrollment }) }),
    ...
    /* @__PURE__ */ jsxs(Card, { children: [
      ...
      /* @__PURE__ */ jsx(TableFooter, { className: "p-5 sm:p-7", routeName: "exam-enrollments.index", paginationInfo: enrollments })
    ] })
  ] });
};
Exams.layout = (page) => /* @__PURE__ */ jsx(DashboardLayout, { children: page });
export {
  Exams as default
};
