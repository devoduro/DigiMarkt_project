...
const CouponTableColumns = ({ exams }) => {
  ...
  return [
    ...
    },
    {
      accessorKey: "exam",
      header: "Exam",
      cell: ({ row }) => row.original.exam ? /* @__PURE__ */ jsx("span", { className: "font-medium", children: row.original.exam.title }) : /* @__PURE__ */ jsx("span", { className: "text-primary font-medium", children: "Global Coupon" })
    },
    {
      accessorKey: "usage",
      header: "Usage",
